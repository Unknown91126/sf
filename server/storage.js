...
var DatabaseStorage = /** @class */ (function () {
    ...
    DatabaseStorage.prototype.createContact = function (insertContact) {
        return __awaiter(this, void 0, void 0, function () {
            var contact;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DatabaseStorage.prototype.getContacts = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_1.contacts)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    DatabaseStorage.prototype.createQuizResult = function (insertQuizResult) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db
                            .insert(schema_1.quizResults)
    ...
    DatabaseStorage.prototype.getQuizResults = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_1.quizResults)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
var MemStorage = /** @class */ (function () {
    ...
    MemStorage.prototype.createContact = function (insertContact) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                contact = __assign(__assign({}, insertContact), { id: id, createdAt: new Date(), newsletter: (_a = insertContact.newsletter) !== null && _a !== void 0 ? _a : null });
    ...
    MemStorage.prototype.createQuizResult = function (insertQuizResult) {
        return __awaiter(this, void 0, void 0, function () {
            var id, result;
            return __generator(this, function (_a) {
                id = this.currentQuizResultId++;
                result = __assign(__assign({}, insertQuizResult), { id: id, createdAt: new Date() });
                this.quizResults.set(id, result);
                return [2 /*return*/, result];
            });
        });
    };
    MemStorage.prototype.getQuizResults = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.quizResults.values())];
            });
        });
    };
    return MemStorage;
